    ...
    class ServiceCli {
        ...
        private function argSwitch($args){
            ...
            switch($args[1]){
                ...
                case '-h':
                    $dialogue = "Usage:\n   ";
                    $dialogue .= "serviceCli --get  | -g <country>                               For a list of records of services under the specified country code \n   ";
                    $dialogue .= "serviceCli --post | -p <ref> <centre> <service> <country>      To insert/update the service records (use an existing reference code to update that specific record)\n";
                ...
                case '-g':
                    if(empty($args[2])){
                        return "\nYou need to supply an argument <country> for serviceCli --get|-g\n\n";
                    }
                ...
                case '-p':
                    ...
                    if(count($args) < 6){
                        return "\nYou need to supply more arguments <ref> <centre> <service> <country> for serviceCli --post|-p\n\n";
                    }

                    $this->post($args);
                    break;
                default:
                    return "\nIncorrect syntax, use serviceCli --help|-h for guidance.\n\n";
            }
        }
